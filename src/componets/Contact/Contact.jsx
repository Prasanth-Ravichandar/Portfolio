...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "b4d8d77d-f76b-48fe-9589-274e8bc24786");
            ...
            <div className="contact-left">
                ...
                <div className="contact-details">
                    <div className="contact-detail">
                       <img src={mail_icon} alt="" /> <p>prashanthvj2002@gmail.com</p> 
                    </div>

                    <div className="contact-detail">
                        <img src={call_icon} alt="" /> <p>7010753250</p>
                        </div>
